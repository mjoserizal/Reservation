                ...
                <div class="flex flex-col md:flex-row">
                    <div class="h-32 md:h-auto md:w-1/2">
                        <img class="object-cover w-full h-full"
                            src="https://asset.kompas.com/crops/B4azCNVvpOxFCwtClowXmCqWGB0=/43x0:1280x825/750x500/data/photo/2021/09/13/613ede55094fb.jpg" alt="img" />
                    </div>
                    <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                        <div class="w-full">
                            ...
                            <form method="POST" action="{{ route('reservations.store.step.one') }}">
                                ...
                                <div>
                                <label for="guest_number" class="block text-sm font-medium text-gray-700"> Captcha </label>
                                <p>
