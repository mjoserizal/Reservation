<x-guest-layout>
    ...
    <div class="container max-w-lg px-4 py-32 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center"
        style="background-image: url('https://i0.wp.com/btp.ac.id/wp-content/uploads/2021/08/238903680_991104711462554_1040452414990941691_n.jpg?resize=1024%2C768&ssl=1')">
        <h1
            ...
            <span class="inline md:block">Welcome To UNSFood Restaurant</span>
        </h1>
        <div class="mx-auto mt-2 text-green-50 md:text-center lg:text-lg">
        UNS Food adalah salah satu unit usaha dari Badan Pengelola Usaha (BPU) UNS yang bergerak di bidang catering, dengan client dari universitas. Saat ini, kami membutuhkan untuk beberapa personil untuk bergabung secepatnya guna menunjang kegiatan operasional UNS Food agar berjalan lancar.
        </div>
    ...
    <section class="px-2 py-32 bg-white md:px-0">
        <div class="container items-center max-w-6xl px-8 mx-auto xl:px-5">
            ...
            > -->
                        ...
                        Sebelas Maret University is an Indonesian public university in the suburban area of Surakarta, Central Java, Indonesia. It was officially founded on March 11, 1976.
                        </p>
                ...
                <div class="w-full md:w-1/2">
                    <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                        <img src="https://i0.wp.com/uns.ac.id/id/wp-content/uploads/Logo-UNS-shadow.png?resize=1024%2C1024&ssl=1" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid gap-2 lg:grid-cols-3">
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                ...
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">Mohammad Jose Rizal</a>
                </div>
            </div>
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div>
                    <h2 class="text-3xl font-semibold text-gray-800">Drink</h2>
                    <p class="mt-2 text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae dolores
                        deserunt
                        ea doloremque natus error, rerum quas odio quaerat nam ex commodi hic, suscipit in a veritatis
                        pariatur
                ...
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">Elvin Kukuh N</a>
                </div>
            </div>
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div>
                ...
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">Irvan Alvian N</a>
                </div>
            </div>
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div>
                ...
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">Farhan Arif S</a>
                </div>
            </div>
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div>
                ...
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">Imam Abdillah P</a>
                </div>
            </div>
        </div>
    </section>
